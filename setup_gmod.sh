...
if [ ! -d ~/gmodds/csgo ]
then
    ~/steamcmd/steamcmd.sh +login anonymous +force_install_dir ../gmodds/csgo +app_update 740 validate +quit
fi
...
~/gmodds/srcds_run -game garrysmod +gamemode prop_hunt +maxplayers 32 +map gm_construct +host_workshop_collection 2215505010 -ip 0.0.0.0 -port 27016 -condebug